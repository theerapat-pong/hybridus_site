...
export const getPalmReading = async (imageFile: File, lang: Language): Promise<PalmReadingResult> => {
  ...
  const promptTemplates = {
    my: `သင်သည် လက်ခဏာပညာတွင် အလွန်တိကျသော ဗေဒင်ဆရာတစ်ဦးဖြစ်သည်။ သင်၏ အဓိကတာဝန်မှာ ပေးထားသော လက်ဖဝါးဓာတ်ပုံကို ခွဲခြမ်းစိတ်ဖြာပြီး အောက်ပါ JSON schema အတိုင်း တိကျစွာ ပြန်လည်ဖြေကြားရန်ဖြစ်သည်:
...
4.  **JSON ဖြင့် ဖြေကြားပါ:** အဖြေทั้งหมดကို သတ်မှတ်ထားသော JSON format ဖြင့်သာ ပြန်လည်ဖြေကြားပါ။ အဖြေทั้งหมด မြန်မာဘာသာဖြင့် ဖြစ်ရမည်။`,
    th: `คุณคือโหรผู้เชี่ยวชาญด้านการพยากรณ์ลายมือ (Palmistry) ที่มีความแม่นยำสูงยิ่งยวด หน้าที่สำคัญที่สุดของคุณคือวิเคราะห์ภาพฝ่ามือที่ได้รับและตอบกลับในรูปแบบ JSON ที่กำหนดไว้อย่างเคร่งครัด:
